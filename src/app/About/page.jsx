...
<div className="leader-tag">
  Bringing global perspective, strategic vision, and the next generation of leadership to Traansbolt Energy.
</div>

<p>
  Arnav Malik brings a fresh global perspective to Traansbolt Energy's
  marketing and strategic growth initiatives. A graduate of the
  University of Glasgow, he combines international academic exposure
  with a strong interest in business development, brand positioning,
  and strategic communication.
</p>

<p>
  At Traansbolt Energy, Arnav is focused on strengthening the company's
  presence across India and international markets. He plays an active
  role in shaping brand strategy, client engagement, and market
  positioning, helping communicate the company's commitment to quality,
  innovation, and reliability.
</p>

<p>
  His work supports projects across critical infrastructure sectors,
  including airports, metro systems, solar PV plants, telecom networks,
  and industrial facilities, where dependable electrical protection and
  energy solutions are essential.
</p>

<p>
  Through exposure to startup ecosystems in both India and the United
  Kingdom, Arnav has gained valuable insight into diverse entrepreneurial
  environments and modern growth strategies. He brings that experience
  to Traansbolt Energy as the company continues to expand its footprint
  in the energy and infrastructure sectors.
</p>

<p>
  As part of the next generation of leadership, Arnav is committed to
  building long-term relationships, strengthening the company's global
  outlook, and supporting Traansbolt's vision of delivering world-class
  energy storage and electrical safety solutions.
</p>
